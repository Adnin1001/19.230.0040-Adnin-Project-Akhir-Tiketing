...
<head>
    ...
    <title>Tiket Bus Rosalia | Top Navigation</title>
...
<body class="hold-transition layout-top-nav">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark"> Tiket Bus Rosalia Online <small>Dashboard</small></h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; <?= date('Y') ?> <a href="https://github.com/Adnin1001/Project-Akhir-Tiketing">Muhammad Adnin Oktafaya</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
