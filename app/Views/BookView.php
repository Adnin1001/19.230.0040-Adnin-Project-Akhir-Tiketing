            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="float-right">
                        <div class="btn-group">
                            <button type="button" class="btn btn-sm btn-block btn-primary" id="create-book" data-toggle="modal" data-target="#modal-create-book"><i class="fa fa-plus"></i> Create Tiket</button>
                        </div>
                    </div>
                </div>
                <!-- /.card-header -->
